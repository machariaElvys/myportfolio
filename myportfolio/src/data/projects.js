...
const projects = [
  {
    ...
    caseStudy: {
      subtitle:
        "Real-time crop health insights powered by weather and soil moisture APIs.",
      overview:
  ...
  },
  {
    ...
    caseStudy: {
      subtitle:
        "A minimalist digital art portfolio showcasing contemporary paintings and visual storytelling.",
      overview:
      ...
      solution:
        "Jada's Art Studio presents artwork in a clean, curated digital space with a structured gallery, responsive layout, and focused visual storytelling.",
      features: [
